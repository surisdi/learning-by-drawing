...
window.onload = () => {
    ...
    * */
    ...
    function setup_project_layer() {
        ...
        function updateRecipeList() {
            ...
            GanterAPI.rankings(sel_project().project, sel_layer())
                .then(ranks => {
            ...
            GanterAPI.levels(sel_project().project, sel_layer())
                .then(level_req => {
        ...
        GanterAPI.allProjects().then((projects) => {
    ...
    * */
    ...
    function update_unit_images(values: number[] = null,
        ...
        GanterAPI.units(sel_project().project, sel_layer())
            .then(unitres => {
    ...
    * */
    ...
    eventHandler.bind(events.picking, () => {
        ...
        GanterAPI.generateFeaturesLocal(
            sel_project().project,
            [pick.id],
            [sel_layer()],
            [{
    ...
    eventHandler.bind(events.dropping, (edata: DropEventData) => {
        ...
        if (bb) {
            GanterAPI.generateImgsIntervention(
                sel_project().project,
                [edata.image.id],
                0,
